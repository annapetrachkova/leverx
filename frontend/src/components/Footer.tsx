                        ...
                        <div className="footer-links">
                            <ul className="footer-icons">
                                <li className="footer-icon-one">
                                    <a href="https://www.facebook.com/leverxint/">
                                        <img src={Facebook} alt={"icon"}/>
                                    </a>
                                </li>
                                <li className="footer-icon-one">
                                    <a href="https://www.instagram.com/leverx_stream/">
                                        <img src={Instagram} alt={"icon"}/>
                                    </a>
                                </li>
                                <li className="footer-icon-one">
                                    <a href="https://leverxpeople.by/">
                                        <img src={Telegram} alt={"icon"}/>
                                    </a>
                                </li>
                            </ul>
                            <a href="https://leverxpeople.by/" className="footer-support">Support</a>
                        </div>
                    </div>
                </footer>
            }
